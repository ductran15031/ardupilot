...
const AP_Param::Info Copter::var_info[] = {
	...
	/*
	// @Param: USING_CONTROLLER
	// @DisplayName: USING_CONTROLLER
	// @Description: Chose one of the controller
	// @Values: 0:Original PID,1:NewPID,2:SimpleIB
	// @User: Standard
	GSCALAR(using_controller, "USING_CONTROLLER",               0),
	
	// @Param: KP_THROTTLE
	// @DisplayName: Kp throttle
	// @Description: kp gain of new throttle PID controller
	// @User: Standard
	GSCALAR(pid_kp_throttle, "A_KP_THROTTLE", KP_THROTTLE_DEFAULT),
	
	// @Param: KI_THROTTLE
	// @DisplayName: Ki throttle
	// @Description: ki gain of new throttle PID controller
	// @User: Standard
	GSCALAR(pid_ki_throttle, "A_KI_THROTTLE", KI_THROTTLE_DEFAULT),
	
	// @Param: KD_THROTTLE
	// @DisplayName: Kd throttle
	// @Description: kd gain of new throttle PID controller
	// @User: Standard
	GSCALAR(pid_kd_throttle, "A_KD_THROTTLE", KD_THROTTLE_DEFAULT),

	// @Param: KP_ROLL
	// @DisplayName: Kp roll
	// @Description: kp gain of new roll PID controller
	// @User: Standard
	GSCALAR(pid_kp_roll, "A_KP_ROLL", KP_ROLL_DEFAULT),


	// @Param: KI_ROLL
	// @DisplayName: Ki roll
	// @Description: ki gain of new roll PID controller
	// @User: Standard
	GSCALAR(pid_ki_roll, "A_KI_ROLL", KI_ROLL_DEFAULT),

	// @Param: KD_ROLL
	// @DisplayName: Kd roll
	// @Description: kd gain of new roll PID controller
	// @User: Standard
	GSCALAR(pid_kd_roll, "A_KD_ROLL", KD_ROLL_DEFAULT),
	
	// @Param: KP_PITCH
	// @DisplayName: Kp pitch
	// @Description: kp gain of new pitch PID controller
	// @User: Standard
	GSCALAR(pid_kp_pitch, "A_KP_PITCH", KP_PITCH_DEFAULT),

	// @Param: KI_PITCH
	// @DisplayName: Ki pitch
	// @Description: ki gain of new pitch PID controller
	// @User: Standard
	GSCALAR(pid_ki_pitch, "A_KI_PITCH", KI_PITCH_DEFAULT),
	
	// @Param: KD_PITCH
	// @DisplayName: Kd pitch
	// @Description: kd gain of new pitch PID controller
	// @User: Standard
	GSCALAR(pid_kd_pitch, "A_KD_PITCH", KD_PITCH_DEFAULT),
	
		
	// @Param: KP_YAW
	// @DisplayName: Kp yaw
	// @Description: kp gain of new yaw PID controller
	// @User: Standard
	GSCALAR(pid_kp_yaw, "A_KP_YAW", KP_YAW_DEFAULT),
	
	// @Param: KI_YAW
	// @DisplayName: Ki yaw
	// @Description: ki gain of new yaw PID controller
	// @User: Standard
	GSCALAR(pid_ki_yaw, "A_KI_YAW", KI_YAW_DEFAULT),
	
	// @Param: KD_YAW
	// @DisplayName: Kd yaw
	// @Description: kd gain of new yaw PID controller
	// @User: Standard
	GSCALAR(pid_kd_yaw, "A_KD_YAW", KD_YAW_DEFAULT),
	*/
	// @Param: A_PWMLEVEL
	// @DisplayName: A_PWMLEVEL
	// @Description: level pwm
	// @Values:
	// @User: Standard
	GSCALAR(level_pwm, "A_LEVEL_PWM",              1500),
	
	// @Param: A_CALIBRATION_PWM
	// @DisplayName: A_CALIBRATION_PWM
	// @Description: for calibration motor
	// @Values:
	// @User: Standard
	GSCALAR(calibration_pwm, "A_CALI_PWM",              1000),
	// @Param: A_CONTROLLER
	// @DisplayName: A_CONTROLLER
	// @Description: Chose one of the controller
	// @Values: 0:Original PID,1:NewPID,2:SimpleIB
	// @User: Standard
	GSCALAR(using_controller, "A_CONTROLLER",               0),
	
	// @Param: KP_THROTTLE
	// @DisplayName: AATHROTTLE_KP
	// @Description: kp gain of new throttle PID controller
	// @User: Standard
	GSCALAR(pid_kp_throttle, "AATHROTTLE_KP", KP_THROTTLE_DEFAULT),
	
	// @Param: KI_THROTTLE
	// @DisplayName: AATHROTTLE_KI
	// @Description: ki gain of new throttle PID controller
	// @User: Standard
	GSCALAR(pid_ki_throttle, "AATHROTTLE_KI", KI_THROTTLE_DEFAULT),
	
	// @Param: KD_THROTTLE
	// @DisplayName: AATHROTTLE_KD
	// @Description: kd gain of new throttle PID controller
	// @User: Standard
	GSCALAR(pid_kd_throttle, "AATHROTTLE_KD", KD_THROTTLE_DEFAULT),

	// @Param: KP_ROLL
	// @DisplayName: AAROLL_KP
	// @Description: kp gain of new roll PID controller
	// @User: Standard
	GSCALAR(pid_kp_roll, "AAROLL_KP", KP_ROLL_DEFAULT),


	// @Param: KI_ROLL
	// @DisplayName: AAROLL_KI
	// @Description: ki gain of new roll PID controller
	// @User: Standard
	GSCALAR(pid_ki_roll, "AAROLL_KI", KI_ROLL_DEFAULT),

	// @Param: KD_ROLL
	// @DisplayName: AAROLL_KD
	// @Description: kd gain of new roll PID controller
	// @User: Standard
	GSCALAR(pid_kd_roll, "AAROLL_KD", KD_ROLL_DEFAULT),
	
	// @Param: KP_PITCH
	// @DisplayName: AAPITCH_KP
	// @Description: kp gain of new pitch PID controller
	// @User: Standard
	GSCALAR(pid_kp_pitch, "AAPITCH_KP", KP_PITCH_DEFAULT),

	// @Param: KI_PITCH
	// @DisplayName: AAPITCH_KI
	// @Description: ki gain of new pitch PID controller
	// @User: Standard
	GSCALAR(pid_ki_pitch, "AAPITCH_KI", KI_PITCH_DEFAULT),
	
	// @Param: KD_PITCH
	// @DisplayName: AAPITCH_KD
	// @Description: kd gain of new pitch PID controller
	// @User: Standard
	GSCALAR(pid_kd_pitch, "AAPITCH_KD", KD_PITCH_DEFAULT),
	
		
	// @Param: KP_YAW
	// @DisplayName: AAYAW_KP
	// @Description: kp gain of new yaw PID controller
	// @User: Standard
	GSCALAR(pid_kp_yaw, "AAYAW_KP", KP_YAW_DEFAULT),
	
	// @Param: KI_YAW
	// @DisplayName: AAYAW_KI
	// @Description: ki gain of new yaw PID controller
	// @User: Standard
	GSCALAR(pid_ki_yaw, "AAYAW_KI", KI_YAW_DEFAULT),
	
	// @Param: KD_YAW
	// @DisplayName: AAYAW_KD
	// @Description: kd gain of new yaw PID controller
	// @User: Standard
	GSCALAR(pid_kd_yaw, "AAYAW_KD", KD_YAW_DEFAULT),
